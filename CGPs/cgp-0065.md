...
title: Top-Up of Governance-Owned cUSD<->USDC Liquidity
...
As during execution of CGP #61, a multisig is required to orchestrate the bridging of USDC from the reserve in Phase II via Wormhole/Portal. This proposal suggest to use the same 4/6 multisig (GnosisSafe) on Ethereum as in CGP #61. The members of this multisig are:
...
* [Forum post related to this CGP](https://forum.celo.org/t/discussion-cgp-60-governance-owned-cusd-usdc-liquidity/4036)
