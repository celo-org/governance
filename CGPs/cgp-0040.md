# CGP [0040]: Contracts Release 6

- Date: 2021-09-19
- Author(s): @luisgj @volpe
- Status: DRAFT
...
In this governance proposal, we propose to execute the Celo Core Contracts Upgrade Release 6, which mainly proposes the activation of the `StableTokenBRL` and `ExchangeBRL` smart contracts.
