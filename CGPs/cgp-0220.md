...
author: 'cLabs Team'
status: EXECUTED
discussions-to: https://forum.celo.org/t/clabs-core-protocol-execution-season-2-h1-2026-funding-proposal
governance-proposal-id: 274
date-executed: 2026-02-12
---
...
2. Fund the Release Contract
  - Goldtoken.transfer
  - Data: transfer(address to = `0xCc651797284339852a38F66C31fAFA8ffE9e8fBE`, uint256 value = `4355627000000000000000000` (approx 4.35M CELO))
  - Value: 0 (It's sent as an ERC20, not as a native transfer)

## Verification
Before approving/voting, fetch the on-chain proposal and verify that the destination address matches the address of the ReleaseGold contract, `0xCc651797284339852a38F66C31fAFA8ffE9e8fBE` and that the amount is 4,355,627 CELO, equivalent to 4355627000000000000000000.
