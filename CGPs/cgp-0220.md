...
The total requested budget of $1,241,914 will be funded through a mix of OP and CELO, with $500,000 in OP and the remaining $741,914 in CELO. At today's prices, $741,914 corresponds to approximately 5,787,161 CELO. Final CELO-denominated amounts and vesting schedules will be calculated using the applicable trailing average CELO price at the time of proposal approval, in line with prior proposals.
...
1. Fund the Release Contract
  - Goldtoken.transfer
  - Data: transfer(address to = `TBD`, uint256 value = `5787161000000000000000000` (approx 5.79M CELO))
...
$ celocli releasecelo:show --contract TBD -n https://forno.celo.org
...
releaseSchedule:
  amountReleasedPerPeriod: TBD # 6 times this value plus 1 CELO equals total grant (contract sends 1 CELO when beneficiary registers a vote signing key)
  releasePeriod: 1 month, 10 hours # monthly vesting
  numReleasePeriods: 6 # 6 month total vest
  releaseCliff: TBD # 2 month cliff
  releaseStartTime: TBD # release start time
```
