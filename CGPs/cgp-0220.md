...
2. Fund the Release Contract
  - Goldtoken.transfer
  - Data: transfer(address to = `0x488deBD4B7646A44cAC389Dae4c6b55aD26C8fA6`, uint256 value = `4355627000000000000000000` (approx 5.79M CELO))
...
releaseSchedule:
  amountReleasedPerPeriod: 725936833333333333333333 (~7.259e+23) # 6 times this value plus 1 CELO equals total grant (contract sends 1 CELO when beneficiary registers a vote signing key)
