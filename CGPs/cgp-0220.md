...
## Verification
Before approving/voting, fetch the on-chain proposal and verify that the destination address matches the address of the ReleaseGold contract, `TBD` and that the amount is 5,787,161 CELO, equivalent to 5787161000000000000000000 or 5.787161e24.
...
releaseSchedule:
  amountReleasedPerPeriod: 725936833333333333333333 (~7.259e+23): TBD # 6 times this value plus 1 CELO equals total grant (contract sends 1 CELO when beneficiary registers a vote signing key)
