...
There is a potential that the allocated funds could be used slowly in the event that there is not a large initial response to the program. To alleviate this potential risk, the necessity of the currently allocated funds will be re-evaluated at the end of a 12 month period beginning with the execution of this proposal.
