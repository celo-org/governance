...
[
  {
    ...
    "function": "transfer",
    "args": [
      "0xE22f947c4CecCf3A38852Ac9f163CaBA925d748C",
...
First, verify the on-chain proposal that 1) the destination address matchs the address of the ReleaseGold contract, 0xE22f947c4CecCf3A38852Ac9f163CaBA925d748C and 2) that the amount is 10,000,000 CELO, equivalent to 10000000000000000000000000 or 1e25.
...
celocli releasecelo:show --contract 0xE22f947c4CecCf3A38852Ac9f163CaBA925d748C --node https://forno.celo.org

In particular check these parameters:

```
releaseOwner: 0x08740BfC4c597921DE895BA549B5CB4D3619da34  # check this is the Timelock contract address
beneficiary: 0xf559940652F887503eAC12F951bdd73bc5B9Bf0B   # CELO-Guild Multisig
maxDistribution: 1000000000000000000000000 (~1.000e+24) # Stage1 1M CELO disbursement
```

Third, verify the Timelock contract [here](https://celoscan.io/address/0x08740bfc4c597921de895ba549b5cb4d3619da34#readContract) that 1) the Celo Governance (0xD533Ca259b330c7A88f74E000a3FaEa2d63B7972) has the CANCELLER_ROLE and 2) the minDelay is 1209600 (60 * 60 * 24 * 14 = 2 weeks). 

To request stage #2, #3 #4 disbursements, CELO-Guild Multisig must propose a transaction in the Timelock contract to call "function setMaxDistribution(uint256 distributionRatio) external onlyReleaseOwner" in ReleaseGold contract, with parameter distributionRatio = 300/600/1000 (30%/60%/100%) for stage #2/#3/#4 to increase maxDistribution to 3M/6M/10M CELO tokens. This transaction can't be executed within 2 weeks due to minDelay in Timelock contract and can be cancelled by Celo Governance.  
