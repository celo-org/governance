...
Two major updates since last proposal:
 ...
 1. We understand that the previous pricing was too high for Celo given Celo's recent price drawdown. Artemis wants to be collaborative long-term partners to the Celo community and so decided to reduce our pricing for Celo by approx. US$?k. This is lower than our standard pricing for ecosystems but we are very excited for the future of Celo and want to make a one-off exception to our pricing model to support Celo.
 2. We are requesting cUSD since there was a lot of concern about sell-pressure on CELO in the last proposal.
