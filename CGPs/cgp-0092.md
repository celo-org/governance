...
governance-proposal-id: '123 - [if submitted]'
date-executed: 'TBD'
...
# _Proposal for $60,000 worth (120.000 Celo) Funding to Support a Mobile-First Community in Celo Ecosystem_
...
contract: GoldToken
    function: approve
    args:
      0:  is this the wallet?
      1: is this the amount?
    params:
      __length__: 2
      spender: is this the wallet?
      value: is this the amount?
    value: 0
metadata:
  proposer:  where is this from?
  deposit:  ???
  timestamp:  ???
  transactionCount: 1
...
## Multisig wallet
[need multisig wallet]

**Signers:**
Jeff Pulver - 0xd933f9D0f63307a4c0d60e3CB0603011b82db3F5
David Casey - wallet address
