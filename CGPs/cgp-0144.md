...
- **Application Activity Monitor**: $131,104 per year
- **Stablecoin Dashboard**: $108,379 per year
...
**Total Funding Request**: US$239,483 per year (509,121 CELO per year) see [here](https://forum.celo.org/t/draft-artemis-proposal-to-build-public-goods-data-dashboards-for-celo-ecosystem-and-community/8384/18?u=andromedae88) for more details.
