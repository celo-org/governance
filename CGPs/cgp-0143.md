...
governance-proposal-id: https://forum.celo.org/t/draft-artemis-proposal-to-build-public-goods-data-dashboards-for-celo-ecosystem-and-community/8384
date-executed:
---

## Overview of Artemis Dashboard Proposal
...
# About Artemis
Artemis is an institutional-grade data provider, specializing in serving respected investors in the crypto space, including Pantera, Dragonfly, Grayscale, VanEck, Coinfund, and Franklin Templeton. We collaborate closely with top blockchains and developers such as Solana, Consensys, Near, and Avalanche to offer reliable data for wallet analysis, application usage analysis, grant efficacy analysis, and stablecoin tracking.

Our data is open source and all dashboards are built as public goods, freely accessible to everyone. You can explore our open-source data here [1]. Artemis builds closely with every ecosystem to ensure that the data we represent is fair, accurate, and transparent.
...
![Screenshot 2024-07-18 at 4.06.50 PM](1618×640 108 KB)
Whereas something like Tron is primarily used for p2p transfers as shown below:
![Screenshot 2024-07-18 at 4.07.31 PM](1620×646 56 KB)
...
Artemis will maintain and continually update the Celo stablecoin dashboard ([Artemis Dashboard 1](https://app.artemis.xyz/stablecoins?chain=celo)). This includes adding new currencies and enhancing user-friendliness to ensure it meets the needs of the community.
