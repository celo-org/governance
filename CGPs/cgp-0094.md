...
`TODO: Explain in the paragraph above that after this proposal passes we will start accumulating EUROC and we will actually add it to the Reserve contract in MU03 (we can't do it now as axlEUROC is still not deployed on Celo but should be within next week).`

We also propose to already add `EUROC/EUR`, `XOF/EUR` and `CELO/XOF` oracle rates in preparation of the upcoming launch of `cEUR/axlEUROC` and `eXOF/axlEUROC` and `CELO/eXOF` Mento pairs. We also propose to add the related `eXOF` entry in the Celo registry. For more background on the upcoming `eXOF` launch, please read [Dunia launching eXOF on Celo](https://forum.celo.org/t/dunia-launching-exof-on-celo/6261).
...
Similar to previous proposals [CGP 71](https://github.com/celo-org/governance/blob/main/CGPs/cgp-0071.md) and [CGP 86](https://github.com/celo-org/governance/blob/main/CGPs/cgp-0086.md), we suggest to associate the `EUROC/EUR` and `XOF/EUR` rate identifiers with the following address derived from their ticker pair:
...
```solidity
address(uint160(uint256(keccak256("XOFEUR"))))
// == 0x39ffa393566659ffc70d76d238cbe9582042f71f
```
...
`TODO: anything to change in the paragraph below?`
...
c) The following address to report the `XOF/EUR` rate:
...
-- `XOF/EUR` oracle rate transactions --

10. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0xf600744e3404de1231c55f4b589cfc722aeb29a9`)
- Value: 0

11. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0x37e0590ef02989b348365f421dbb0431d427f80f`)
- Value: 0

12. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0xc5e71d35f93b7eb743b97a87903952feff8a7a72`)
- Value: 0

13. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0xc42e2061a94f0fd25e33b83f0a5727790b0d51d4`)
- Value: 0

14. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0xd8229cb8a8d59aebb99391cd6854bc0601eea9a7`)
- Value: 0

15. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0x358e2a342a1d14c0d9cc3ce1ca9d5f5a0d978489`)
- Value: 0

16. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0x3390bd1eb0882eaaa509db104c6be8e6565412ab`)
- Value: 0

17. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0xf09a03a874b07473d5b6d4112a5448b37ff56a0f`)
- Value: 0

18. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0xeb05235169538d73ee24fbc4f96ada3d94166efb`)
- Value: 0

19. Whitelist oracles

- Destination: SortedOracles.addOracle
- Data: `0x39ffa393566659ffc70d76d238cbe9582042f71f`, `0x9f695cbb32e43f80149ccf254a8b72820a647e1e`)
- Value: 0
