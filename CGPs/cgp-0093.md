...
status: REJECTED
discussions-to: 'https://forum.celo.org/t/proposal-refi-dao-x-celo-onboarding-the-next-generation-of-talent-and-capital'
governance-proposal-id: 126
date-executed:
---
...
You can see the complete list of founders, investors and events, content, and deals on our website: [refidao.com](https://refidao.com/)
...
At the same time, engaging with crypto is still a fringe behavior accessible only to a fraction of society. If we want to regenerate the earth, we need a radically different approach.
...
Having trained directly with Dr. BJ Fogg of Stanford University, we’ll employ leading behavior science to build daily, weekly, and monthly habits to change the behavior of key leaders and their identity—the critical piece of the regenerative transition.
...
We aim to engage key stakeholders across key capital allocators like Celo Foundation, Climate Collective, Credit Collective, and Flori Ventures, as well as vital ecosystem initiatives like impactMarket, GoodDollar, Grassroots Economics, EthicHub, and Kolektivo.
...
## Total Budget 587,000 CELO (approx. 267,000 EUR)
- Core team operating expenditure: 132,000 CELO (approx. 60,000 EUR)
- Projects Budget 455,000 CELO (approx. 207,000 EUR)

## Projects
We’ll undertake four distinct projects for a total of 455,000 CELO (approx. 207,000 EUR):
- I. Discover: 110,000 CELO (approx 50,000 EUR)
- II. Local Node Incubator: 125k CELO (approx 57,000 EUR)
- III. Source Studios: 110,000 CELO (approx 50,000 EUR)
- IV. Annual Meeting: 110,000 CELO (approx 50,000 EUR)


### I. Discover - 110,000 CELO (Approx. 50,000 EUR)
The Discovery phase aims to understand the critical leverage points across the Celo and ReFi DAO ecosystems. We need to test product and behavior assumptions through prototypes before pursuing production-grade engineering.
...
### II. Local Node Incubator - 125,000 CELO (Approx 57,000 EUR)
Starting in Q4, we plan to pilot a Local Node Incubator and grants program on Celo via Allo Protocol that will propagate prosperous, founder-led startup communities in key cities (known as Local Nodes). The purpose of these nodes is to onboard talent and capital into ReFi via regular events.
...
The vision is to realize a city-level global coordination layer that actively onboards new users into ReFi via Valora and later a ‘ClassPass for regeneration’ mobile dApp. This will attract diverse value-aligned talent and capital into the Celo ecosystem. 

This is a crucial foundation of the product vision, which will enable any organization to incentivize a global network to take a specific action on-chain and gain rewards. Imagine impactMarket, GoodDollar, or EthicHub being able to activate a global network to a specific action through a rewards mechanism.
...
5. Develop a v2.0 Local Node Toolkit for running fantastic events, attracting top leaders, and much more.
...
### III. Source Studios - 110,000 CELO (Approx. 50,000 EUR)
Following the success of the ReFi Podcast, we want to launch a new brand called 'Source Studios' to support the emergence of up-and-coming regenerative storytellers in web3 and beyond. Think of it like the ‘Bankless’ for ReFi, focusing on the global south and real-world climate solutions enabled by web3, AI, and other technologies.

Thanks to Climate Collective and Celo Foundation’s support, we’ve produced the #1 podcast in the ReFi movement, reaching over 60k downloads with 28 episodes and 35 pieces of micro-content.

As a result of existing grant capital, we have begun production on three new shows in three languages and are seeking 50k EUR to fulfill the following objectives:
...
### IV. Annual Meeting: Davos for ReFi - 110,000 CELO (Approx. 50,000 EUR)
...
- Daryl Edwards 🇨🇦 - advisor, executive coach

We’ll be compensating the core team with a temporarily reduced mean salary of 3,333 EUR per month, with an expectation to increase back-to-market rates as we gain further funding. 

### Costs
- 6 core team members at an average of 3,333 EUR per month = 60,000 EUR (approx.132,000 CELO)

EUR Denominated Budget

Given most of the core team and project expenditure is located in Europe, the currency of choice mitigates the risk of potential market fluctuations.
...
| Chief of Staff             | Emilie Viallon         | 0xC7Bf34CF2C5FFBAEb9f8Ff79F9535F6123da34DF |
...
### Command
* celocli governance:show --proposalID 126 --node https://forno.celo.org

### Expected output:
```
Running Checks:
   ✔  126 is an existing proposal 
proposal: 
  0:
      contract: GoldToken
