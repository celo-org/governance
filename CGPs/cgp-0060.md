...
## Market Interference
Whenever arbitrageurs have matched cUSD/USDCe prices on other pools with the StableSwap pool, most users will trade with the reserve StableSwap pool. Due to the setup (see [Arbitrage and Dex Competition](#arbitrage-and-dex-competition) ) it has lower fees and slippage especially for larger trades. If DEX routers include the StableSwap pool, this shift of trading volume towards the StableSwap pool will become even more likely.
