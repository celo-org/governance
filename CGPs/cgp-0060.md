...
![](https://drive.google.com/uc?export=view&id=1t_2NblwYnwicws58O83FzdEbMcr-Q0Rc)
...
Therefore we recommend this three-step process:
 ...
 1. Transfer from USDC from Custodian to GnosisSafe Multisig
...
The below diagram provides on overview over the changes this CGP proposes:

![](https://drive.google.com/uc?export=view&id=1lMSImCRbRA9a0zXiQ5GGSraDfaSZePha)

More precisely, this CGP proposes the following:
